...
void markObject(Obj* object) {
    ...
    // Add the gray object to the worklist
    // We use the system realloc instead of reallocate, so that GC doesn't get
    // recursively triggered.
    if (vm.grayCapacity < vm.grayCount + 1) {
        vm.grayCapacity = GROW_CAPACITY(vm.grayCapacity);
        vm.grayStack =
            (Obj**)realloc(vm.grayStack, sizeof(Obj*) * vm.grayCapacity);
        // TODO: Make a rainy day fund. See above 26.4.3
...
static void blackenObject(Obj* object) {
    ...
    switch (object->type) {
        ...
        case OBJ_UPVALUE:
            ...
            break;
        // These don't have any outgoing references.
        case OBJ_NATIVE:
        case OBJ_STRING:
            break;
    }
